...
window.login = async function () {
    ...
    try {
        ...
        // Hide public website content
        document.querySelectorAll(
            "body > section, body > div.section-image2, body > div.section-image3, body > div.section-image4, body > div.section-image5, body > div.section-image6, body > nav, body > footer, body > a.home-arrow"
        ).forEach(element => {
